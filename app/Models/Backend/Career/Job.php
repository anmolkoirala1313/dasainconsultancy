...
class Job extends BackendBaseModel
{
    ...
    protected $fillable =['id','name','title','code','slug','lt_number','required_number','formlink','min_qualification','image','salary','description','end_date','start_date','status','extra_company','meta_title','meta_tags','meta_description','created_by','updated_by'];
